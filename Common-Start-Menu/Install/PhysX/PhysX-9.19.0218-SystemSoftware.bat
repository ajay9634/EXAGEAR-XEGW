...
IF EXIST "Z:/opt/wget_files/physx/PhysX-9.19.0218-SystemSoftware.din" (
    ...
    echo.
    wget q --show-progress -P "Z:/opt/wget_files/temp/PhysX-9.19.0218-SystemSoftware.exe" --progress=dot:mega Z:/opt/wget_files/temp/PhysX-9.19.0218-SystemSoftware.exe https://us.download.nvidia.com/Windows/9.19.0218/PhysX-9.19.0218-SystemSoftware.exe
