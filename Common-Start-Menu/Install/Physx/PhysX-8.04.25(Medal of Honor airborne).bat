...
IF NOT EXIST "Z:\opt\wget_files\physx\PhysX_8.04.25_SystemSoftware.part1.rar" (
    wget -P Z:/opt/wget_files/temp/ --progress=dot:mega https://raw.githubusercontent.com/ajay9634/Ajay-prefix/Resources/My-files/PhysX_8.04.25_SystemSoftware.part1.rar
