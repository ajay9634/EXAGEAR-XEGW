...
color 1f
echo ==================================
set "installname=Wine-6.23-staging"
...
echo.
wget -q --show-progress -P "Z:/opt/wget_files/temp/" --progress=dot:mega https://github.com/ajay9634/EXAGEAR-XEGW/raw/Resources/Wine/%installname%-x86.tar.xz
