...
:Scripts_Check
IF NOT EXIST "Z:\opt\AutoIt3_Scripts\Path2Exe Converter.bat" (
...
color 1f
echo *** Opening ...***
IF EXIST "Z:\opt\AutoIt3_Scripts\Path2Exe Converter.bat" (
    cls
    call "Z:\opt\AutoIt3_Scripts\Path2Exe Converter.bat"
) ELSE (
    echo File not Found
    pause
)
