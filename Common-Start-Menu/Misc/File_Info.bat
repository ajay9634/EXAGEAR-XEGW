...
:Scripts_Check
IF NOT EXIST "Z:\opt\AutoIt3_Scripts\File_Info.ajau3" (
...
color 1f
echo *** Opening ...***
IF EXIST "Z:\opt\AutoIt3_Scripts\File_Info.ajau3" (
    start "" "C:\Program Files\AutoIt3\AutoIt3.exe" "Z:\opt\AutoIt3_Scripts\File_Info.ajau3"
) ELSE (
    echo File not Found
    pause
)
